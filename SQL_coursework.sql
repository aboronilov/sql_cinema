...
-- для реализации отношений многие ко многим - в одном кино может быть много актеров и наоборот
...
-- Отобрать фильмы Американского производства. Упорядочить по убыванию прибыли. Указать режиссера
...
-- Найти фильм французского производства с самым высоким рейтингом. Вывести главного актера и рейтинг
...
-- Отобрать актеров, у которых более одного фильма в подборке.
